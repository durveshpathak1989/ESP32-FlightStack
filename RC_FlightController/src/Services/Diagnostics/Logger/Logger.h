...
struct LoggerRow {
    ...
    float ekf_pos_z_m;
    float ekf_vel_z_mps;
    uint16_t tof_ekf_age_ms;
    uint8_t tof_ekf_velocity_accepted;
    uint8_t altitude_hold_requested;
    uint8_t altitude_hold_ready;
    uint8_t altitude_hold_active;
    float altitude_hold_setpoint_m;
    float altitude_hold_error_m;
    float altitude_hold_throttle_trim;
    uint8_t gps_valid;
    uint8_t gps_sats;
    float gps_hdop;
};
