...
#include <WebServer.h>
#include <Update.h>
#include "../../../EcuAbstraction/Receiver/iFly/FlySkyiBUS.h"
...
struct TelemetryPacket {
    ...
    uint8_t tof_stream_count;
    float tof_signal_mcps;
    float tof_ambient_mcps;
    uint32_t tof_age_ms;
    uint32_t tof_last_update_ms;
    bool tof_ready;
    bool tof_valid;

    float ekf_pos_z_m, ekf_vel_z_mps;
    uint32_t tof_ekf_last_fused_ms, tof_ekf_age_ms;
    bool tof_ekf_velocity_accepted;
    bool altitude_hold_requested, altitude_hold_ready, altitude_hold_active;
    float altitude_hold_setpoint_m, altitude_hold_error_m, altitude_hold_throttle_trim;
...
struct TunePacket {
    ...
    // ToF altitude-hold tuning
    bool has_alt_hold_kp;
    bool has_alt_hold_kd;
    bool has_alt_hold_max_trim;
