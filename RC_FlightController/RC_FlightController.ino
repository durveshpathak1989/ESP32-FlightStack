...
static constexpr uint32_t DYN_NOTCH_UPDATE_MS       = 100;     // 10 Hz update rate
static constexpr float    DYN_NOTCH_ALPHA           = 0.15f;   // smoothing
static constexpr float    DYN_NOTCH_MAX_STEP_HZ     = 4.0f;    // max movement per update
